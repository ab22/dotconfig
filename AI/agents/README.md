...
Keep the repo's own `AGENTS.md` as the entry point, copy the module in, and
...
```markdown
<!-- Vendored copy of the shared agent module `workflow.md` (ab22/dotconfig, AI/agents).
     Do not edit this file directly — change the canonical module and re-vendor it. -->
```
