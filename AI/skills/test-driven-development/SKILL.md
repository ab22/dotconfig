...
whenToUse: Implementing or changing behaviour, fixing a bug, or adding edge-case handling.
---

> **Workspace overrides — these win over the vendored text below.**
> After writing the RED test, run it and confirm it fails for the expected
> reason, then **stop and hand the failing test to the user** with the red
